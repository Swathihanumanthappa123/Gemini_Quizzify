...
class ChromaCollectionCreator:
    ...
    def create_chroma_collection(self):
        ...
        texts = text_splitter.create_documents([str(page) for page in self.processor.pages])
        #texts = CharacterTextSplitter.split_text(self.processor, separator='\n', chunk_size=1000, chunk_overlap=100)
